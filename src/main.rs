...
fn main() -> Result<(), ImageDataErrors> {
    ...
    let combined_data = comnbine_images(image_1, image_2);
...
fn get_smallest_dimension(dim_1: (u32, u32), dim_2: (u32, u32)) -> (u32, u32) {
    ...
    let pixel_2 = dim_2.0 * dim_2.1;
    return if pixel_1 < pixel_2 { dim_1 } else { dim_2 };
}
...
fn comnbine_images(image_1: DynamicImage, image_2: DynamicImage) -> Vec<u8> {
